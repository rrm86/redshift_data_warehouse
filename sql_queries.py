...
staging_events_table_create= ("""CREATE TABLE IF NOT EXISTS staging_events(
                                artist TEXT, auth TEXT, first_name TEXT,
                                gender CHAR(1), item_session INTEGER,
                                last_name TEXT, length NUMERIC,
                                level TEXT, location TEXT,
                                method TEXT, page TEXT,
                                registration NUMERIC,
                                session_id INTEGER,
                                song TEXT, status INTEGER,
                                ts BIGINT, user_agent TEXT,
                                user_id INTEGER)
""")
                
                
staging_songs_table_create = ("""CREATE  TABLE IF NOT EXISTS staging_songs(
                                num_songs INTEGER, artist_id TEXT,
...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplay(
                            ...
                            artist_id TEXT, session_id INTEGER,
...
song_table_insert = ("""INSERT INTO song(song_id, artist_id, year, duration)
                        SELECT song_id, artist_id, year, duration
                        FROM staging_songs
                        WHERE song_id IS NOT NULL
""")

artist_table_insert = ("""INSERT INTO artist(artist_id, name, location, latitude, longitude)
                          SELECT distinct artist_id, substring(artist_name ,0,254), 
                          substring(artist_location,0,254), 
